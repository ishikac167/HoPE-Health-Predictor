...
class SignalProcess:
    ...
    def filter_out(self, signals, low_c=0.5, high_c=2.0):
        ...
        for signal_data in signals:
            filter_out = self.filter_signal(
                signal_data, fs=self.fs, low_c=low_c, high_c=high_c)
    ...
    def get_mean(self, filtered_signals, show=True):
        ...
        maxFreq, percentage = self.get_dominant_frequency(
            mean_signal, fs=self.fs, draw=False)
