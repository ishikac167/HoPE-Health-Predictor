...
class TrackPoints:
    ...
    def get_first_points(self, prev_frame, curr_frame):
        ...
        if track_point_candidates is not None:
            ...
            if self.face.dedector_type == 'face_shape':
                ...
                initial_points = self.filter_unbacktrackable(
                    prev_frame, curr_frame, track_point_candidates)
    ...
    def filter_unbacktrackable(self, prev_frame, curr_frame, track_point_candidates, ret_nextPts=False):
        ...
        nextPts, st, err = cv2.calcOpticalFlowPyrLK(
            prev_frame, curr_frame, track_point_candidates, None, **self.lk_params)
        # Backward optical flow
        backNextPts, _st, _err = cv2.calcOpticalFlowPyrLK(
            curr_frame, prev_frame, nextPts, None, **self.lk_params)
    ...
    def track_points(self, prev_frame, curr_frame):
        ...
        nextPts, bool_filter = self.filter_unbacktrackable(
            prev_frame, curr_frame, prevPts, ret_nextPts=True)
